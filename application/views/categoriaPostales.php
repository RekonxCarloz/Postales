    ...
    <main class="page gallery-page">
        <section class="clean-block clean-gallery dark">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 item"><a class="lightbox" href="assets/img/postales/amor-amistad/image1.jpg"><img class="img-thumbnail img-fluid image" src="assets/img/postales/amor-amistad/image1.jpg"></a></div>
